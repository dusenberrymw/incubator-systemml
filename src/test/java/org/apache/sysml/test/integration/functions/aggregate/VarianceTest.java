...
public class VarianceTest extends AutomatedTestBase {
    ...
    public void testVarianceDenseMatrixCP() {
        testVariance(TEST_NAME, false, false, ExecType.CP);
    }

    @Test
    public void testVarianceDenseMatrixSpark() {
        testVariance(TEST_NAME, false, false, ExecType.SPARK);
    }

    @Test
    public void testVarianceDenseMatrixMR() {
        testVariance(TEST_NAME, false, false, ExecType.MR);
    }

    // Dense vector
    @Test
    public void testVarianceDenseVectorCP() {
        testVariance(TEST_NAME, false, true, ExecType.CP);
    }

    @Test
    public void testVarianceDenseVectorSpark() {
        testVariance(TEST_NAME, false, true, ExecType.SPARK);
    }

    @Test
    public void testVarianceDenseVectorMR() {
        testVariance(TEST_NAME, false, true, ExecType.MR);
    }

    // Sparse matrix
    @Test
    public void testVarianceSparseMatrixCP() {
        testVariance(TEST_NAME, true, false, ExecType.CP);
    }

    @Test
    public void testVarianceSparseMatrixSpark() {
        testVariance(TEST_NAME, true, false, ExecType.SPARK);
    }

    @Test
    public void testVarianceSparseMatrixMR() {
        testVariance(TEST_NAME, true, false, ExecType.MR);
    }

    // Sparse vector
    @Test
    public void testVarianceSparseVectorCP() {
        testVariance(TEST_NAME, true, true, ExecType.CP);
    }

    @Test
    public void testVarianceSparseVectorSpark() {
        testVariance(TEST_NAME, true, true, ExecType.SPARK);
    }

    @Test
    public void testVarianceSparseVectorMR() {
        testVariance(TEST_NAME, true, true, ExecType.MR);
    }
     ...
     */
    private void testVariance(String testName, boolean sparse, boolean vector,
                              ExecType platform) {
