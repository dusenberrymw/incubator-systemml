...
public class RowVariancesTest extends AutomatedTestBase {
    ...
    // Dense matrix
    @Test
    public void testRowVariancesDenseMatrixCP() {
        testRowVariances(TEST_NAME, false, false, ExecType.CP);
    }

    @Test
    public void testRowVariancesDenseMatrixSpark() {
        testRowVariances(TEST_NAME, false, false, ExecType.SPARK);
    }

    @Test
    public void testRowVariancesDenseMatrixMR() {
        testRowVariances(TEST_NAME, false, false, ExecType.MR);
    }

    // Dense vector
    @Test
    public void testRowVariancesDenseVectorCP() {
        testRowVariances(TEST_NAME, false, true, ExecType.CP);
    }

    @Test
    public void testRowVariancesDenseVectorSpark() {
        testRowVariances(TEST_NAME, false, true, ExecType.SPARK);
    }

    @Test
    public void testRowVariancesDenseVectorMR() {
        testRowVariances(TEST_NAME, false, true, ExecType.MR);
    }

    // Sparse matrix
    @Test
    public void testRowVariancesSparseMatrixCP() {
        testRowVariances(TEST_NAME, true, false, ExecType.CP);
    }

    @Test
    public void testRowVariancesSparseMatrixSpark() {
        testRowVariances(TEST_NAME, true, false, ExecType.SPARK);
    }

    @Test
    public void testRowVariancesSparseMatrixMR() {
        testRowVariances(TEST_NAME, true, false, ExecType.MR);
    }

    // Sparse vector
    @Test
    public void testRowVariancesSparseVectorCP() {
        testRowVariances(TEST_NAME, true, true, ExecType.CP);
    }

    @Test
    public void testRowVariancesSparseVectorSpark() {
        testRowVariances(TEST_NAME, true, true, ExecType.SPARK);
    }

    @Test
    public void testRowVariancesSparseVectorMR() {
        testRowVariances(TEST_NAME, true, true, ExecType.MR);
    }
     ...
     */
    private void testRowVariances(String testName, boolean sparse, boolean vector,
                                  ExecType platform) {
